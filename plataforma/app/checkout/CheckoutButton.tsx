    ...
    <>
      ...
      <div className="space-y-2">
        ...
        <button
          onClick={() => pay("mp")}
          disabled={!!loading}
          className="w-full bg-[#009ee3] hover:bg-[#0082bc] disabled:opacity-60 text-white font-bold py-3.5 rounded-xl transition-all flex items-center justify-center gap-2 text-sm"
        >
          {loading === "mp" ? (
            <span className="animate-spin w-4 h-4 border-2 border-white border-t-transparent rounded-full" />
          ) : (
          ...
          {loading === "mp" ? "Redirecionando…" : "Mercado Pago · parcelado em até 12x"}
        </button>
