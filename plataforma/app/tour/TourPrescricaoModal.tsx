...
import PrescricaoContent from "@/app/dashboard/prescricoes/PrescricaoContent";
...
export default function TourPrescricaoModal({ titulo, categoria, conteudo, children }: Props) {
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-200 sticky top-0 bg-white rounded-t-2xl z-10">
              <div>
                <span className="text-[10px] font-bold text-red-500 uppercase tracking-widest">{categoria}</span>
            ...
            <div className="px-6 py-4 border-t border-zinc-100 bg-[#f8fafc] rounded-b-2xl text-center">
              <p className="text-xs text-zinc-500 mb-2">
                Acesse todos os {`>`} 220 modelos com a assinatura Rotina Clínica
              </p>
              <a
                href="/assinatura"
