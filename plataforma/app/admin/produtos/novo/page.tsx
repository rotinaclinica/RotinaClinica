    ...
    <div className="max-w-2xl">
      ...
      <form action={action} className="bg-white rounded-2xl border border-zinc-200 p-6 space-y-5">
        ...
        <div>
          ...
          />
          <p className="text-xs text-zinc-600 dark:text-zinc-400 mt-1">Deixe em branco para gerar automaticamente do título.</p>
        </div>
        ...
        <div>
          ...
          />
          <p className="text-xs text-zinc-600 dark:text-zinc-400 mt-1">Caminho do arquivo no Cloudflare R2.</p>
        </div>
