...
const mobileItems = [
  ...
  { href: "/dashboard/prescricoes", label: "Prescrições", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" },
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-[#0f2d4a] border-t border-white/10 z-50">
      <div className="flex items-center justify-around px-2 py-2 safe-area-pb">
        ...
        {/* Separador + toggle tema */}
        <div className="w-px h-8 bg-white/10 self-center mx-1 flex-shrink-0" />
        <ThemeToggle className="flex flex-col items-center gap-0.5 px-2 py-1.5 rounded-xl text-[#5a8caa] hover:text-white transition-all" />
      </div>
    </nav>
  );
}
