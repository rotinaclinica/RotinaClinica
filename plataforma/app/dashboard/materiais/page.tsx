  ...
  return (
    <div className="flex-1 flex flex-col min-h-screen">
      <header className="bg-white dark:bg-[#131c2e] border-b border-zinc-200 dark:border-white/8 px-6 sm:px-8 py-6">
        <h1 className="text-xl sm:text-2xl font-extrabold text-[#0f2d4a] dark:text-[#e8edf5] mb-1">Ebooks e Materiais</h1>
        <p className="text-zinc-500 dark:text-[#6a8fa5] text-sm">PDFs e materiais de apoio para baixar e consultar offline.</p>
      </header>
      ...
      <main className="flex-1 p-6 sm:p-8 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-zinc-400 dark:text-[#5a7a8e] max-w-xs">Os ebooks e materiais de apoio chegarão em breve.</p>
        </div>
      </main>
    </div>
  );
