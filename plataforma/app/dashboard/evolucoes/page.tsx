      ...
      <div className="relative bg-white dark:bg-[#131c2e] w-full h-full sm:h-auto sm:max-w-2xl sm:rounded-2xl shadow-2xl flex flex-col sm:max-h-[85dvh]">
        ...
        <div className="flex items-start gap-3 p-5 border-b border-zinc-200 dark:border-white/8 flex-shrink-0">
          ...
          <button
            onClick={handleCopy}
            disabled={!conteudo}
            className={`flex-shrink-0 inline-flex items-center gap-1.5 h-8 px-3 rounded-full text-xs font-bold transition-colors mt-0.5 disabled:opacity-40 ${
              copied
                ? "bg-green-100 text-green-700 dark:bg-green-500/20 dark:text-green-400"
                : "bg-[#3db8d4]/15 text-[#1a6aad] dark:text-[#3db8d4] hover:bg-[#3db8d4]/25"
            }`}
