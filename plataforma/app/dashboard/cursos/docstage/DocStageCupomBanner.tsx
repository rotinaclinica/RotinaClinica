...
export default function DocStageCupomBanner() {
  ...
  return (
    <div className="mb-6 rounded-2xl bg-gradient-to-br from-[#0f2d4a] to-[#1a4a7a] border border-[#3db8d4]/30 overflow-hidden">
      <div className="p-5 flex flex-col gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white font-extrabold text-base leading-snug">Utilize nosso cupom e ganhe 50% de desconto na 1ª mensalidade</p>
            {copiado && (
