...
export const alt = "Calculadoras Clínicas — Rotina Clínica";
    ...
    (
      ...
      >
        ...
        <span style={{ color: "#ffffff", fontSize: 64, fontWeight: 800, lineHeight: 1.15, marginBottom: 28 }}>
          30 calculadoras clínicas{"\n"}validadas.
        </span>

        <span style={{ color: "#a8c4d8", fontSize: 26, fontWeight: 400, lineHeight: 1.5, maxWidth: 780 }}>
          SOFA, qSOFA, Wells, CURB-65, NEWS2, Braden e muito mais — integradas na plataforma, sem apps separados.
        </span>
