...
const sections = [
  ...
  },
  {
    href: "/dashboard/cid",
    label: "CID-10",
    description: "Busque por código ou nome da doença/condição em 12.451 diagnósticos.",
    badge: "Classificação Internacional",
            ...
            >
              ...
              <div className="p-5">
                <div className="flex items-start justify-between gap-2 mb-3">
                  ...
                  {s.badge && (
                    <span className="text-[10px] font-bold bg-[#3db8d4]/15 dark:bg-[#3db8d4]/20 text-[#1a6aad] dark:text-[#3db8d4] px-2.5 py-1 rounded-xl leading-tight whitespace-nowrap w-fit">
                      {s.badge}
                    </span>
                  )}
                </div>
