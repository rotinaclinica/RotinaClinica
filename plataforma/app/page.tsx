        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={nome + texto} className="flex flex-col gap-3 p-5 rounded-2xl border border-zinc-300 bg-white shadow-sm">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-2">
            <span className="text-xs text-[#334e68] font-semibold mr-1">Também avaliaram com 5 estrelas:</span>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              { icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>, titulo: "CID-10", desc: "Busca rápida por diagnóstico ou código para atestados, laudos e AIH — tabela completa DATASUS." },
              { icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>, titulo: "Anotações", desc: "Bloco de notas clínico salvo na sua conta — acessível em qualquer dispositivo, exportável em PDF." },
            ].map((item) => (
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            ...
            >
              ...
              <span className="text-white/60 text-xs mb-5">Novos vídeos toda semana</span>
